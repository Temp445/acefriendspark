    ...
    <section className="relative bg-gradient-to-b from-slate-50 via-white to-slate-50 py-20 overflow-hidden">
      <div className="container mx-auto px-4 lg:px-6 xl:px-14  relative z-10">
        <div className="text-center mb-8 lg:mb-1 animate-fade-in">
          ...
          <h2 className="text-3xl md:text-5xl 2xl:text-6xl font-serif text-gray-900 mb-4 tracking-tight">
            Best Places{" "}
          ...
          <p className="text-gray-600 text-base md:text-lg max-w-2xl mx-auto">
            Explore stunning destinations and hidden gems just moments away from
            your stay
          </p>
        </div>
        ...
        <div className="lg:flex justify-end items-end mb-3 hidden">
          <Link
            href="/attractions"
            className="inline-flex items-center gap-2 hover:bg-[#D46A37] text-[#D46A37] hover:text-white border px-6 py-2 rounded font-semibold  shadow-lg hover:shadow-xl transform transition-all duration-300"
          >
            View More
