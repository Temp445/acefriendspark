    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-100">
        <div className="flex flex-col items-center gap-3">
          <div className="w-8 h-8 border-4 border-blue-200 border-t-black rounded-full animate-spin" />
  ...
  <div className="max-w-md w-full text-center relative">
    <div className="bg-white/70 backdrop-blur-sm rounded-xl shadow-2xl p-8 md:p-12 border border-black/40 ">
      ...
      <div className="flex flex-col sm:flex-row gap-3 justify-center">
        <button
          onClick={() => router.push('/')}
          className="group relative px-8 py-3 text-black border hover:border-0  hover:bg-[#D46A37] hover:text-white rounded font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200 flex items-center justify-center gap-2"
        >
