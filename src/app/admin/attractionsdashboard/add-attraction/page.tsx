...
const AddAttractionPage = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        alert('Attraction uploaded successfully!');
        window.location.href = '/admin/attractionsdashboard';
      } else {
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="group">
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 border border-gray-600 rounded transition-all outline-none text-gray-900"
            ...
            <div className="group">
              ...
              <textarea
                ...
                required
                className="w-full px-4 py-3 border border-gray-600 rounded outline-none resize-none text-gray-900"
                rows={4}
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <button
                  type="button"
                  onClick={addKeyPoint}
                  className="w-fit px-5 py-3 border border-dashed border-gray-700 rounded text-gray-700  transition-all font-medium"
                >
                  + Add Another Point
                </button>
              </div>
